...
import {
    FiMapPin, FiCalendar, FiShield, FiStar,
    FiMessageCircle, FiPlus, FiCheckCircle
} from 'react-icons/fi';
...
export default function UserProfile({ id }: UserProfileProps) {
    ...
    const user = {
        ...
        reviews: [
            { id: 1, author: "Aiko Tanaka", rating: 5, date: "2 days ago", content: "Great seller! The car was exactly as described and very clean." },
            { id: 2, author: "Kenji Sato", rating: 4, date: "1 week ago", content: "Fast communication. Smooth transaction." }
        ],
        recentProducts: [
            { id: "1", title: "Tesla Model 3 Performance", price: "$35,000", location: "Tokyo, Japan", imageUrl: "/listing_vehicle_tesla_1769261698522.png" },
            { id: "3", title: "RTX 4090 Gaming Laptop", price: "$1,200", location: "Kyoto, Japan", imageUrl: "/listing_electronics_laptop_gaming_1769261730700.png" }
        ]
    };
        ...
        <main className="min-h-screen bg-white">
                        ...
                        <div className="flex-1 text-center md:text-left space-y-6">
                            <div>
                                <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                                    <h1 className="text-4xl font-bold font-poppins text-black">{user.name}</h1>
                                    {user.verified && <FiCheckCircle className="text-primary" size={24} />}
                                </div>
                            ...
                            <p className="text-gray-600 max-w-2xl text-lg leading-relaxed">{user.bio}</p>
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-8 pt-2">
                                <div>
                                    ...
                                    <div className="text-xs font-bold uppercase tracking-widest text-gray-400">Listings</div>
                                </div>
                                <div>
                                    <div className="text-2xl font-black text-black flex items-center gap-1">
                                        {user.rating} <FiStar className="fill-yellow-500 text-yellow-500" size={20} />
                                    </div>
                                    <div className="text-xs font-bold uppercase tracking-widest text-gray-400">{user.reviewsCount} Reviews</div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container py-20">
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-16">
                    {/* Listings */}
                    <section>
                        <h2 className="text-2xl font-bold font-poppins text-black mb-10">Active Listings</h2>
                    ...
                    <section>
                        <div className="flex items-center justify-between mb-10">
                            <h2 className="text-2xl font-bold font-poppins text-black">Member Feedback</h2>
                        </div>
                                ...
                                <div key={review.id} className="border-b border-gray-100 pb-8 last:border-0">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className="flex text-yellow-500">
                                            {[...Array(review.rating)].map((_, i) => <FiStar key={i} size={14} className="fill-current" />)}
                                        </div>
                                    </div>
            ...
            {isReviewModalOpen && (
                <div className="fixed inset-0 z-3000 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white w-full max-w-md rounded-[32px] p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
                        <h3 className="text-2xl font-bold font-poppins text-black mb-2">Write a Review</h3>
                        <p className="text-gray-500 mb-8 font-medium">How was your experience with Marcus?</p>
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="flex gap-2">
                                    {[1, 2, 3, 4, 5].map(star => (
                                        ...
                                        >
                                            <FiStar
                                                size={32}
                                                className={star <= rating ? "fill-yellow-500 text-yellow-500" : "text-gray-200"}
                                            />
                                        </button>
                                    ))}
                                </div>
                            ...
                            <div>
                                <label className="block text-sm font-bold text-black mb-3 ml-1">Your Comment</label>
                                <textarea
                                    value={comment}
